...
class _HomePageState extends State<HomePage> {
  ...
  final medias = [
    MusicMetadata(
      ...
      mediaId: "bamboo",
      mediaUri: "asset:///images/ambient_c_motion.mp3",
    ...
    MusicMetadata(
      ...
      mediaId: "rise",
      mediaUri: "https://luan.xyz/files/audio/nasa_on_a_mission.mp3",
    ...
    MusicMetadata(
      ...
      mediaId: "hide",
      mediaUri: "http://bbcmedia.ic.llnwd.net/stream/bbcmedia_radio1xtra_mf_p",
      ...
      floatingActionButton: Consumer<PlayerController>(
        builder: (context, playerPro, child){
          return FloatingActionButton(
            onPressed: () {
              PlayQueue queue = PlayQueue(queueTitle: "Simple Test", queueId: "test", queue: medias);
              // Perform play operation.
              player.playWithQueue(queue);
              playerPro.increment();
            },
            tooltip: 'Increment',
            child: child,
